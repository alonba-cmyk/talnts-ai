...
export function WorkManagementCTASection() {
  return (
    <section className="py-20 sm:py-28 px-4 sm:px-6 bg-[#6161FF]/5 relative overflow-hidden">
      ...
      <div className="relative max-w-[1120px] mx-auto text-center">
        ...
        >
          <div className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/80 border border-[#6161FF]/20">
            <img
              src={sidekickLogo}
              alt="Sidekick"
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-black tracking-[-0.02em] leading-tight max-w-[810px]">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 h-12 px-8 bg-black hover:bg-gray-800 text-white font-medium text-base rounded-[40px] transition-colors"
          >
            Get started
