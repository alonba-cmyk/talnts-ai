...
export const SQUAD_DEPARTMENTS: SquadDepartment[] = [
  {
    ...
    jtbd: ['Plan campaign launches', 'Generate creative assets', 'Analyze campaign ROI', 'Track brand consistency'],
    members: [
          ...
          >
            {leadImage ? (
              <div className="w-full h-full rounded-full overflow-hidden">
                <img src={leadImage} alt={leadLabel} className="w-full h-full object-cover" />
              </div>
            ) : (
        ...
        >
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <span
                className="italic"
                style={{ color: colorOverrides[dept.id] || dept.color }}
              >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {centerImage ? (
                              <div className="w-full h-full rounded-full overflow-hidden">
                                <img src={centerImage} alt={`${dept.name} Lead`} className="w-full h-full object-cover" />
                              </div>
                            ) : (
