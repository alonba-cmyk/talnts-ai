...
export default function CategoryPositioningSlide() {
  return (
    <SlideShell dark>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 mt-10 max-w-4xl mx-auto">
        <motion.div
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.5, delay: 0.2 }}
          className="flex-1 w-full p-8 rounded-2xl border border-white/[0.1] bg-white/[0.03]"
        >
        ...
        <motion.div
          ...
          className="shrink-0 flex items-center justify-center text-[#00D2D2]"
        >
        ...
        <motion.div
          ...
          className="flex-1 w-full p-8 rounded-2xl border-2 border-[#00D2D2]/40 bg-[#00D2D2]/5"
        >
