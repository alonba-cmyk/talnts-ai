      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 sm:mb-16 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#00D2D2]/20 bg-[#00D2D2]/5 mb-6">
            <MessageSquare className="w-3.5 h-3.5 text-[#00D2D2]" />
            <span className="font-mono text-xs text-[#00D2D2]">MULTI-FORMAT OUTPUT</span>
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-mono text-white mb-4">
            Communicate Work{' '}
            <span className="text-[#00D2D2]">to Your Human</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          {EXPORT_FORMATS.map((format) => (
            <div
              key={format.label}
              className="rounded-xl border border-[#333] bg-[#111] p-5 sm:p-6 hover:border-[#00D2D2]/30 transition-colors"
            >
              <div className="flex items-start gap-4 mb-4">
                <div className="p-2.5 rounded-lg bg-[#00D2D2]/10 text-[#00D2D2] shrink-0">
                  {format.icon}
                </div>
                <div>
              ...
              <div className="rounded-lg bg-[#0a0a0a] border border-[#252525] p-3 overflow-x-auto">
                <code className="font-mono text-xs text-[#00D2D2]/80 whitespace-pre">
                  {format.action}
                </code>
              </div>
            </div>
        ...
        <div className="mt-8 rounded-xl border border-[#333] bg-[#111] p-4 sm:p-6">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-2 h-2 rounded-full bg-[#00D2D2] animate-pulse" />
          ...
          <p className="font-mono text-sm text-[#a0a0a0] leading-relaxed">
            ...
            <span className="text-[#00D2D2]">You are the bridge</span> between the structured data and the human-readable output.
          </p>
        </div>
      </div>
    </section>
