...
export const benefitsCopy: Record<MessagingTone, BenefitsCopy> = {
  belong_here: {
    ...
    footerCommand: '$ echo "Total cost: $0.00/month \u2014 unlimited time on Free plan"',
    footerOutput: 'Total cost: $0.00/month \u2014 no credit card needed',
  ...
  machine_personality: {
    ...
    headingAccent: 'for $0',
    subtitle: 'Unlimited time on Free plan. Unlimited boards, full GraphQL API, 8 view types, docs, dashboards, and 200+ integrations. No credit card needed.',
    footerCommand: '$ echo "How much does this cost?"',
    footerOutput: 'Nothing. Zero. Nada. $0/month \u2014 no credit card needed.',
  ...
  agent_pov: {
    ...
    footerOutput: '{ "result": "UNLIMITED_FREE_PLAN", "restrictions": "NONE" }',
  ...
  system_native: {
    ...
    footerOutput: '{ "monthly_cost": 0, "credit_card": false, "expiry": null }',
