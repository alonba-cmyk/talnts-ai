    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-20 font-mono text-sm leading-relaxed">
      ...
      <section id="gotcha" className="mb-10 sm:mb-16">
        ...
        <p className="text-[#808080] mb-4">
          This page is actually built for agents to read. But the value? That's for you.
          When your agent works on monday.com, you get more done with less effort.
        </p>
      </section>
      ...
      <section id="use-cases" className="mb-10 sm:mb-16">
        ...
        <p className="text-[#a0a0a0] mb-6">
          Having an AI agent on monday.com isn't about replacing you — it's about giving you back your time.
          Here's what changes when your agent joins your workspace:
        </p>
      ...
      <section id="why" className="mb-10 sm:mb-16">
        ...
        <p className="text-[#a0a0a0] mb-6">
          Teams using AI agents alongside monday.com see concrete improvements across the board:
        </p>
        <ul className="space-y-4 text-[#a0a0a0]">
          <li className="flex gap-3">
      ...
      <section className="mb-10 sm:mb-16">
        ...
        <p className="text-[#808080] mb-4">
          The challenges include Base64 decoding, fast arithmetic, and hex-to-ASCII conversion — trivial for
          an AI agent (solved in milliseconds) but tedious for a human.
        </p>
      ...
      <section id="security" className="mb-10 sm:mb-16">
        ...
        <p className="text-[#a0a0a0] mb-4">
          Absolutely. monday.com meets the highest enterprise security standards — the same ones
          used by Fortune 500 companies. Agent accounts inherit the same protections as human accounts.
        </p>
