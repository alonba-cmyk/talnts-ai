  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex">
      ...
      >
        ...
        >
          <h1 className="text-2xl font-bold text-white mb-2">Sign in to your company account</h1>
          ...
          <p className="text-slate-400 text-sm mt-6 text-center">
            ...
            <Link to="/talnt/company/register" className="text-indigo-400 hover:text-indigo-300">
              Register
            </Link>
          </p>
        </motion.div>
      ...
      >
        ...
        >
          <h2 className="text-2xl font-bold text-white mb-4">Your dashboard awaits</h2>
